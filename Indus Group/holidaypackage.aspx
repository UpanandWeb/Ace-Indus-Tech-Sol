                        ...
                        <div class="card text-dark">
                               <asp:DataList ID="dl2" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" Width="100%" OnItemCommand="dl2_ItemCommand" >
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:ImageButton ID="im1" runat="server" Width="250px" Height="250px"  AlternateText="No Image" CssClass="card-img-top" ImageUrl='<%# Eval("imagename", "images/{0}") %>' CommandName="view" CommandArgument='<%#Eval("id") %>' />
