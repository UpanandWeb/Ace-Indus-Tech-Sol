...
$(function() {
	...
	//$('.box, #rightcol, .wp-pagenavi .current, .wp-pagenavi a, .wp-pagenavi .current, .topnav ul li ul li ul   ').css({"border-radius":"5px", "-moz-border-radius":"5px", "-webkit-border-radius":"5px"});
