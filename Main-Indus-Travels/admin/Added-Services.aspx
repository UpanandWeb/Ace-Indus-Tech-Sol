...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table width="100%" align="center">
        ...
        <tr>
           <td><asp:RadioButton ID="rad" runat="server" Text="View Data" Font-Size="24px" GroupName="rad" Checked="true" /><asp:RadioButton ID="RadioButton1" runat="server" Text="Add Page" GroupName="rad" Checked="true" Font-Size="24px" /></td>
        </tr>
        <tr>
            <td>
                            ...
                            <table width=100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="DropDownList2" InitialValue="0" ValidationGroup="val1" ErrorMessage="Add Subtitle" ForeColor="Red">*</asp:RequiredFieldValidator>
                                    </td>
                                </tr>
