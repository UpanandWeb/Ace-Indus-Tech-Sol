<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Admin-company.aspx.cs" Inherits="admin_Admin_company" ValidateRequest="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br />
    <table align="center">
        <tr id="tdh1" runat="server">
            <td><h1 align="center" id="td1" runat="server" style="color:#096aac">Company Details</h1></td>
            </tr>
        <tr>
        <td align="right" id="tdbtn" runat="server">
    ...
    <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" PageSize="20" ShowFooter="True" OnRowCommand="gv_RowCommand" OnRowDataBound="gv_RowDataBound" OnRowDeleting="gv_RowDeleting"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ControlStyle-Width="150px" HeaderStyle-Width="150px" FooterStyle-Width="150px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblcontent" runat="server" Text='<%#Eval("cont") %>' Font-Size="20px" ForeColor="Black"></asp:Label>
                 ...
                 <tr>
                        ...
                        <td>
                           <asp:DropDownList ID="DropDownList3" runat="server" Font-Size="20px" AppendDataBoundItems="true" AutoPostBack="true">
                                ...
                                <asp:ListItem Value="1"> Indus Travels Is Your Global Travel Partner </asp:ListItem>
                            </asp:DropDownList>
